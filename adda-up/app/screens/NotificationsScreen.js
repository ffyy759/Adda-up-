      ...
      {unreadCount > 0 && (
        <View style={styles.unreadBanner}>
          <Text style={styles.unreadBannerText}>
            {unreadCount} naya notification hai! 🔥
          </Text>
        </View>
      )}
...
const styles = StyleSheet.create({
  ...
  markReadBtn: {
    backgroundColor: '#ff6b3520', paddingHorizontal: 12,
    paddingVertical: 6, borderRadius: 12,
  },
  markReadText: { color: '#ff6b35', fontSize: 12, fontWeight: 'bold' },
  unreadBanner: {
    backgroundColor: '#ff6b3518', padding: 10, alignItems: 'center',
    borderBottomWidth: 1, borderBottomColor: '#ff6b3530',
  },
  ...
  notifUnread: {
    borderColor: '#ff6b3555', backgroundColor: '#ff6b350a',
  },
  ...
  coinPill: {
    backgroundColor: '#ffd70022', paddingHorizontal: 8,
